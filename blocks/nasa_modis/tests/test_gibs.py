    ...
    query = STACQuery.from_dict(
        {
            ...
            "limit":
                2,
            "bbox":
                [114.11227717995645, -21.861101064554884, 114.20209027826787, -21.764821237030162]
        }
    )
    ...
    query = STACQuery.from_dict(
        {
            "zoom_level":
                9,
            "time":
                "2019-04-20T16:40:49+00:00/2019-04-25T17:45:49+00:00",
            "limit":
                2,
            "bbox":
                [114.11227717995645, -21.861101064554884, 114.20209027826787, -21.764821237030162]
    ...
    query = STACQuery.from_dict(
        {
            "zoom_level":
                9,
            "time":
                "2019-04-01T16:40:49+00:00/2019-04-02T16:41:49+00:00",
            "limit":
                4,
            "bbox":
                [114.11227717995645, -21.861101064554884, 114.20209027826787, -21.764821237030162]
...
def test_download_wmts_tile_as_geotiff(requests_mock):
    ...
    expected_meta = {
        ...
        'transform':
            Affine(
                305.74811314070394, 0.0, 2661231.5767766964, 0.0, -305.7481131407094,
                -3443946.746416901
            )
    }
